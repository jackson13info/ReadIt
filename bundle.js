...
/***/ function(module, exports, __webpack_require__) {
	...
	var Home = __webpack_require__(197),
		Feed = __webpack_require__(199),
		Comment = __webpack_require__(200);
		
	var routes = (
		React.createElement(Route, {handler: Home, name: "home", path: "/"}, 
			React.createElement(DefaultRoute, {handler: Feed, name: "feed"}), 
			React.createElement(Route, {handler: Comment, path: "comments/:postURL", name: "comments"})
		)
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var NavigationBar = __webpack_require__(198);
		...
		render: function() {
			...
			return (
				React.createElement("div", null, 
					React.createElement(NavigationBar, {elements: elements}), 
	...
	var NavigationBar = React.createClass({displayName: "NavigationBar",
		render: function() {
			var elements = this.props.elements.map(function (element) {
				return (
					React.createElement(NavigationElement, {title: element.title})
				);
			});
			return (
				React.createElement("div", {className: "navigationBox"}, 
					elements
				)
			);
		}
	});
	var NavigationElement = React.createClass({displayName: "NavigationElement",
		render: function() {
			return (
				React.createElement("div", {className: "navigationElement"}, 
					this.props.title
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function() {
			return (
				React.createElement("div", {className: "mainView"}, 
					React.createElement(PostBox, {pollInterval: this.props.pollInterval})
				)
			)
		}
	});
	...
	var PostList = React.createClass({displayName: "PostList",
		render: function() {
			var posts = this.props.posts.map(function (post) {
				return (
					React.createElement("div", null, 
						React.createElement(Link, {to: "comments", params: {postURL: encodeURIComponent(post.data.permalink)}}, 
							React.createElement(Post, {author: post.data.author, title: post.data.title, time: post.data.created_utc, url: post.data.url, content: post.data.selftext})
						)
					)
				);
			});
	...
	var Post = React.createClass({displayName: "Post",
		render: function() {
			...
			if (imgURL.length == 0) {
				content = React.createElement(PostContent, {type: "text", content: this.props.content})
			}
			else {
				content = React.createElement(PostContent, {type: "image", url: imgURL})
			}
			return (
				React.createElement("div", {className: "post"}, 
					React.createElement(PostTitle, {author: this.props.author, time: this.props.time}), 
					React.createElement("br", null), this.props.title, 
					content
				)
			);
		}
		...
		render: function() {
			return (
				React.createElement("div", {className: "postTitle"}, 
					...
					React.createElement("div", {className: "time"}, this.state.timeString)
				)
			)
		}
	});
	var PostContent = React.createClass({displayName: "PostContent",
		render: function() {
			...
			if (this.props.type == "image") {
				...
				content = React.createElement("div", {className: "textContent", style: textStyle}, text);
			}
			return (
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentsView = React.createClass({displayName: "CommentsView",
		render: function() {
			return (
				React.createElement("div", {className: "commentsView"}, 
					React.createElement(CommentBox, {pollInterval: this.props.pollInterval, postURL: this.props.params.postURL})
				)
			)
		}
	});
		...
		render: function() {
			return (
				React.createElement("div", {className: "commentBox"}, 
					React.createElement(CommentList, {comments: this.state.comments, indentLevel: "0"})
				)
			);
		}
	});
		...
		render: function() {
			...
			var comments = this.props.comments.map(function (comment) {
				...
				if (comment.data.replies) {
					replies = React.createElement(CommentList, {comments: comment.data.replies.data.children, indentLevel: (indent + 1)});
				}
				return (
					React.createElement("div", null, 
						React.createElement(Comment, {author: comment.data.author, title: comment.data.body, time: comment.data.created_utc, url: comment.data.url, indentLevel: indent}), 
						replies
					)
				);
			}.bind(this));
	...
	var Comment = React.createClass({displayName: "Comment",
		render: function() {
			...
			for (var i = 1; i <= indent; i++) {
				...
				borders.push(React.createElement("div", {className: "borders", style: borderStyle}));
			}
			return (
				React.createElement("div", {className: "comment", style: commentStyle}, 
					borders, 
					React.createElement(CommentTitle, {author: this.props.author, time: this.props.time}), 
					React.createElement("br", null), this.props.title
				)
			);
		}
	...
	var CommentTitle = React.createClass({displayName: "CommentTitle",
		...
		render: function() {
			return (
				React.createElement("div", {className: "commentTitle"}, 
					React.createElement("div", {className: "author"}, this.props.author, " "), 
					React.createElement("div", {className: "time"}, this.state.timeString)
				)
			)
	...
	var CommentContent = React.createClass({displayName: "CommentContent",
		render: function() {
			...
			return (
				React.createElement("div", {className: "commentContent"}, 
					content
				)
			);
		}
